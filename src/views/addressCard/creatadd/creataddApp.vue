<template>
  <div id="app">
    ...
    <section class="contents">
      ...
      <div class="selects-country">
        <select style="width: 100%;height: 50px;background-color: #eff0f3;padding-left:10px;">
      ...
      <div class="weekend-delivery">
       <a>
         <div>
           <p> WEEKEND DELIVERY</p>
...
.weekend-delivery a div:first-child p:first-child{
  font-weight: 600;
}
